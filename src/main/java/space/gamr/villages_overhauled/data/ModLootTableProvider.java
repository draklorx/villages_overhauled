...
public class ModLootTableProvider extends LootTableProvider {
    ...
    public static class ModBlockLootTables extends BlockLootTables {
        ...
        protected void addTables() {
            registerDropSelfLootTable(ModBlocks.COBBLED_SANDSTONE.get());
            registerLootTable(ModBlocks.SAND_PATH.get(), dropping(Blocks.SAND));
            //registerLootTable(Blocks.SANDSTONE, dropping(ModBlocks.COBBLED_SANDSTONE.get()));
        }
